...
docker build -t mantisbase -f docker/Dockerfile --build-arg MB_VERSION=0.4.4 .
...
| `MB_VERSION` | Build-time only: release version to download (Dockerfile `ARG`) | `0.4.4` |
