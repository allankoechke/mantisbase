...
System endpoints are grouped under `/api/v1/sys/`.

### Health Check

| Method | Endpoint | Description |
|--------|----------|-------------|
| GET | `/api/v1/sys/health` | Server health and uptime |
