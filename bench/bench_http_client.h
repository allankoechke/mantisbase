#ifndef MANTISBASE_BENCH_HTTP_CLIENT_H
#define MANTISBASE_BENCH_HTTP_CLIENT_H

// Standalone copy of the drogon-based test HTTP client for the bench binary,
// which builds without tests/ (see bench/CMakeLists.txt). Kept in sync
// manually with tests/common/test_http_client.h; same TestHttp API.
